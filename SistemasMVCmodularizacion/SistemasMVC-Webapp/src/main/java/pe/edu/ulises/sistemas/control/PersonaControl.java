 ...
 */
package pe.edu.ulises.sistemas.control;
...
import pe.edu.ulises.sistemas.modelo.Producto;
import pe.edu.ulises.sistemas.modelo.Venta;
import pe.edu.ulises.sistemas.servicio.PersonaServicioI;
import pe.edu.ulises.sistemas.servicio.ProductoServicioI;
import pe.edu.ulises.sistemas.servicio.VentaServicioI;
...
public ModelAndView inicio(Locale locale, Map<String,Object> model){
    String welcome=messageSource.getMessage("welcome.message", new Object[]{"ulises Labra Chino"}, locale);
